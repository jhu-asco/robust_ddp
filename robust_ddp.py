...
from .robust_obstacle_cost import RobustSphericalObstacle
...
class RobustDdp(Ddp)
    def __init__(self, *args, **kwargs):
        ...
        n = self.dynamics.n
        self.Sigma = np.empty((N+1, n, n))
        self.Sigma[0] = 0.1*np.eye(self.dynamics.n)

    def setInitialCovariance(self, Sigma0, Sigmaw):
        self.Sigma[0] = Sigma0
        self.Sigmaw = Sigmaw
    ...
    def forward_pass_step(self, Ks, xs, us, alpha):
        ...
        for k in range(self.N):
            ...
            RobustSphericalObstacle.set_buffer_ellipsoid(Sigma)
